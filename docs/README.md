...
**Status:** documentation complete (12/12) · Phase 0 not started · see implementation-plan.md → "Immediate Next Actions"
...
- Keep all 13 files in the repo root or `/docs`; reference them by name in prompts ("build P2 per decision-protocols.md and agent-specifications.md §3.2").
...
---
*Documentation set v1.0 · June 2026 · This is a research/learning project trading paper money; nothing herein is investment advice.*
